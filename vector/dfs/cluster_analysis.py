...
movement_type_keywords = {
    ...
    "bodyweight": [
        "air squat", 'pistol', "push up", "hand-release push up", "ring push up",
        "pike push up", "lunge", "walking lunge", "shoulder tap", "dip",
    ],
    "gymnastics": [
        "rope climb", "muscle up", "muscle-up", "ring", "pull over", "toes to",
        "knee raise", "knees to elbows", "peg board", "pull up", "pull-up", "pullup",
        "bar dip", "handstand", "wall walk", "chest to bar",
    ],
    "full_body": [
        "medicine ball clean", "wall ball shot", "step up", 'step over', "wallball", "wall ball",
        "devil press"
    ],
    "core": [
...
odd_keywords = ['sandbag', 'odd', 'sled', 'box push']
